...
input_filename = 'output_threshold_final/final_threshold_pb_{:.0f}_{:.0f}_i20000_1.pickle'.format(passband_low,
                                                                                                      passband_high)
...
for i_file in range(number_of_files):
    input_filename = 'output_threshold_final/final_threshold_pb_{:.0f}_{:.0f}_i20000_{}.pickle'.format(passband_low,
                                                                                                      passband_high,
                                                                                            i_file)
    data = []
    data = io_utilities.read_pickle(input_filename, encoding='latin1')
